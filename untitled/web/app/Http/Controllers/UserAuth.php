    ...
    function userLogin(Request $request){
        ...
        foreach ($user->all() as $u){
            if($u['email'] == $email and  $u['password'] == $password){
                ...
                $id = $u->id;
                return redirect('/profile/all'. $u->id);
//                    ?->action([MainController::class, 'profile'] $u['id']);
            }
        }
    ...
    function userReg(Request $request){
        $user = new User1();
